        ...
        function generateCard(cardData) {
            return `
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column align-items-start">
                            ...
                            <div class="dropdown mt-3">
                                <i class="fas fa-ellipsis-v btn" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                    ...
                    <div class="card-author d-flex flex-column justify-content-between align-items-start px-2 pb-3">
                        <div class="user d-flex gap-2 align-items-center">
                            <img class="rounded-circle me-2 m-2"
                                src="${cardData.author.photo}"
                                alt="User Image" width="40" height="40">
                            <div>
                                <p class="h5 text-muted">${cardData.author.name}</p>
                            </div>
                        </div>
